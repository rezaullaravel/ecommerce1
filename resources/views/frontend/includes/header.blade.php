    ...
    <div class="container">
      <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-3 logo-holder"> 
          <!-- ============================================================= LOGO ============================================================= -->
          <div class="logo"> <a href="{{ route('/') }}"> <img src="{{asset('/')}}frontend/assets/images/logo.png" alt="logo"> </a> </div>
          <!-- /.logo --> 
          <!-- ============================================================= LOGO : END ============================================================= --> </div>
        <!-- /.logo-holder -->
                      ...
                      <div class="yamm-content ">
                        <div class="row">
                          ...
                          <div class="col-xs-12 col-sm-6 col-md-2 col-menu">
                            ...
                            <ul class="links">
                              <li><a href="{{ route('subsubcatwise.product',$subsubcategory->id) }}">{{$subsubcategory->subsubcategory_name}}</a></li>
